...
setRPGWASobjInCPP <- function(t_Tarvec, t_Riskvec, t_designMat, t_GRM, t_resid, t_lambda, t_gammas, t_gamma_riskVec, t_beta_null, t_resid_risk, t_t0, t_resid_unrelated_outliers, t_sum_R_nonOutlier, t_R_GRM_R_nonOutlier, t_R_GRM_R_TwoSubjOutlier, t_R_GRM_R, t_MAF_interval, t_TwoSubj_list, t_ThreeSubj_list, t_SPA_Cutoff, t_zeta, t_tol) {
    invisible(.Call(`_GRAB_setRPGWASobjInCPP`, t_Tarvec, t_Riskvec, t_designMat, t_GRM, t_resid, t_lambda, t_gammas, t_gamma_riskVec, t_beta_null, t_resid_risk, t_t0, t_resid_unrelated_outliers, t_sum_R_nonOutlier, t_R_GRM_R_nonOutlier, t_R_GRM_R_TwoSubjOutlier, t_R_GRM_R, t_MAF_interval, t_TwoSubj_list, t_ThreeSubj_list, t_SPA_Cutoff, t_zeta, t_tol))
}
